...
class Meal(Uuidable):
    ...
    item_1_quantity = models.DecimalField(max_digits=3, decimal_places=2)
    item_2 = models.ForeignKey(Food, on_delete=models.CASCADE, related_name='meal_items_2', null=True, blank=True)
    item_2_quantity = models.DecimalField(max_digits=3, decimal_places=2, null=True, blank=True)
    item_3 = models.ForeignKey(Food, on_delete=models.CASCADE, related_name='meal_items_3', null=True, blank=True)
    item_3_quantity = models.DecimalField(max_digits=3, decimal_places=2, null=True, blank=True)
    item_4 = models.ForeignKey(Food, on_delete=models.CASCADE, related_name='meal_items_4', null=True, blank=True)
    item_4_quantity = models.DecimalField(max_digits=3, decimal_places=2, null=True, blank=True)
    item_5 = models.ForeignKey(Food, on_delete=models.CASCADE, related_name='meal_items_5', null=True, blank=True)
    item_5_quantity = models.DecimalField(max_digits=3, decimal_places=2, null=True, blank=True)
